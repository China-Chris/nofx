...
export const translations = {
  en: {
    ...
    telegramIdHelper: 'Used to encrypt and sync DeepSeek/Hyperliquid credentials to Supabase',
    telegramIdRequired: 'Telegram ID is required when configuring DeepSeek or Hyperliquid',
  ...
  zh: {
    ...
    signalSource: '信号源',
    telegramId: 'Telegram 用户ID',
    telegramIdPlaceholder: '请输入你的 Telegram 用户ID',
    telegramIdHelper: '用于将 DeepSeek / Hyperliquid 密钥加密并同步到 Supabase',
    telegramIdRequired: '配置 DeepSeek 或 Hyperliquid 时必须填写 Telegram ID',
